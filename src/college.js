...
class college extends React.Component{
    ...
    filterCallBack = (e) => {
        if(this.state.selectValue === "both" && this.state.selectValue1 === "All"){
            return true
        }
        else if(this.state.selectValue == "both" && this.state.SelectValue1 != "All"){
            // console.log(e.state, this.state.selectValue1);
            if(e.state == this.state.SelectValue1){
            ...
            if(e.ownership == this.state.SelectValue){
                return true;
            }
            else{
                return false;
            ...
            if(e.ownership == this.state.SelectValue && e.state == this.state.SelectValue1){
                return true;
            }
            else{
                return false;
